...
public partial class BlackBirdTicketManagementDbContext : DbContext
{
    public BlackBirdTicketManagementDbContext()
    {
    }

    public BlackBirdTicketManagementDbContext(DbContextOptions<BlackBirdTicketManagementDbContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=(local);Database=BlackBird.TicketManagement.DB;Integrated Security=true;TrustServerCertificate=True;Persist Security Info=True; Encrypt=Optional;Command Timeout=120;MultipleActiveResultSets=true;Max Pool Size=200;Application Name=BlackBird.TicketManagement");
